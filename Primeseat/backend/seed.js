...
const users = [
    { name: 'Tony Stark', email: 'admin@primeseat.com', password: 'password123', role: 'admin' },
    { name: 'Peter Parker', email: 'user@primeseat.com', password: 'password123', role: 'user' },
    { name: 'Steve Rogers', email: 'steve@primeseat.com', password: 'password123', role: 'user' },
    { name: 'Bruce Banner', email: 'bruce@primeseat.com', password: 'password123', role: 'user' },
    { name: 'Natasha Romanoff', email: 'natasha@primeseat.com', password: 'password123', role: 'user' },
    { name: 'Thor Odinson', email: 'thor@primeseat.com', password: 'password123', role: 'user' },
    { name: 'Wanda Maximoff', email: 'wanda@primeseat.com', password: 'password123', role: 'user' },
    { name: 'Stephen Strange', email: 'strange@primeseat.com', password: 'password123', role: 'user' },
    { name: 'Carol Danvers', email: 'carol@primeseat.com', password: 'password123', role: 'user' },
    { name: 'Clint Barton', email: 'clint@primeseat.com', password: 'password123', role: 'user' }
];
...
const seedDatabase = async () => {
    try {
        await mongoose.connect(process.env.MONGO_URI || 'mongodb://localhost:27017/primeseat');
        ...
        console.log('-------------------------------------------');
        console.log('Admin Email: admin@primeseat.com');
        console.log('User Email:  user@primeseat.com');
